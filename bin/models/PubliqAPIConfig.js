...
var PubliqAPIConfig = /** @class */ (function (_super) {
    __extends(PubliqAPIConfig, _super);
    function PubliqAPIConfig(data) {
        var _this = _super.call(this) || this;
        if (data !== undefined) {
            if (data.p2pBindToAddress !== undefined) {
                _this.p2pBindToAddress = new PubliqAPIIPAddress_1.default(data.p2p_bind_to_address === undefined ? data.p2pBindToAddress : data.p2p_bind_to_address);
            }
            if (data.p2pConnectToAddresses !== undefined) {
                _this.p2pConnectToAddresses = data.p2p_connect_to_addresses === undefined ? data.p2pConnectToAddresses.map(function (d) { return new PubliqAPIIPAddress_1.default(d); }) : data.p2p_connect_to_addresses.map(function (d) { return new PubliqAPIIPAddress_1.default(d); });
            }
            if (data.rpcBindToAddress !== undefined) {
                _this.rpcBindToAddress = new PubliqAPIIPAddress_1.default(data.rpc_bind_to_address === undefined ? data.rpcBindToAddress : data.rpc_bind_to_address);
            }
            if (data.slaveBindToAddress !== undefined) {
                _this.slaveBindToAddress = new PubliqAPIIPAddress_1.default(data.slave_bind_to_address === undefined ? data.slaveBindToAddress : data.slave_bind_to_address);
            }
            if (data.publicAddress !== undefined) {
                _this.publicAddress = new PubliqAPIIPAddress_1.default(data.public_address === undefined ? data.publicAddress : data.public_address);
            }
            if (data.publicSslAddress !== undefined) {
                _this.publicSslAddress = new PubliqAPIIPAddress_1.default(data.public_ssl_address === undefined ? data.publicSslAddress : data.public_ssl_address);
            }
            ...
            if (data.automaticFee !== undefined) {
                _this.automaticFee = new PubliqAPICoin_1.default(data.automatic_fee === undefined ? data.automaticFee : data.automatic_fee);
            }
    ...
    Object.defineProperty(PubliqAPIConfig, "PropertyMap", {
        get: function () {
            return {
    ...
    Object.defineProperty(PubliqAPIConfig, "Rtt", {
        get: function () {
            return 117;
        },
        enumerable: true,
    ...
    return PubliqAPIConfig;
}(BaseModel_1.default));
exports.default = PubliqAPIConfig;
