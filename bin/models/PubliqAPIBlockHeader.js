...
var PubliqAPIBlockHeader = /** @class */ (function (_super) {
    __extends(PubliqAPIBlockHeader, _super);
    function PubliqAPIBlockHeader(data) {
    ...
    Object.defineProperty(PubliqAPIBlockHeader, "PropertyMap", {
        get: function () {
            return {
    ...
    Object.defineProperty(PubliqAPIBlockHeader, "Rtt", {
        get: function () {
            return 5;
        },
        enumerable: true,
    ...
    return PubliqAPIBlockHeader;
}(BaseModel_1.default));
exports.default = PubliqAPIBlockHeader;
