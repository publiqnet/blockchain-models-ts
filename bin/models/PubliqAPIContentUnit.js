...
var PubliqAPIContentUnit = /** @class */ (function (_super) {
    __extends(PubliqAPIContentUnit, _super);
    function PubliqAPIContentUnit(data) {
    ...
    Object.defineProperty(PubliqAPIContentUnit, "PropertyMap", {
        get: function () {
            return {
                uri: 'uri',
    ...
    Object.defineProperty(PubliqAPIContentUnit, "Rtt", {
        get: function () {
            return 30;
        },
        enumerable: true,
    ...
    return PubliqAPIContentUnit;
}(BaseModel_1.default));
exports.default = PubliqAPIContentUnit;
