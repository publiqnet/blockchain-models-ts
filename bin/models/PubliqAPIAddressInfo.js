...
var PubliqAPIAddressInfo = /** @class */ (function (_super) {
    __extends(PubliqAPIAddressInfo, _super);
    function PubliqAPIAddressInfo(data) {
    ...
    Object.defineProperty(PubliqAPIAddressInfo, "PropertyMap", {
        get: function () {
            return {
    ...
    Object.defineProperty(PubliqAPIAddressInfo, "Rtt", {
        get: function () {
            return 33;
        },
        enumerable: true,
    ...
    return PubliqAPIAddressInfo;
}(BaseModel_1.default));
exports.default = PubliqAPIAddressInfo;
