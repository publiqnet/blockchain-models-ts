    ...
    constructor(data?: any) { 
        ...
        if (data !== undefined) {
           ...
           if(is<string>(_to)){
               ...
               throw new Error(`Type Error: PubliqReward to is not a string`)
           }
           ...
           if(is<PubliqCoin>(_amount)){
               ...
               throw new Error(`Type Error: PubliqReward amount is not a PubliqCoin`)
           }
           ...
           if(is<number>(_rewardType)){
               ...
               throw new Error(`Type Error: PubliqReward rewardType is not a number`)
           }
